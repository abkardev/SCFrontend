...
import { RegisterPage, ForgotPasswordPage, ResetPasswordPage } from './components/auth/AuthPages.jsx';
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/" element={<RequireAuth><Layout /></RequireAuth>}>
            ...
            <Route path="users" element={<RequireRole role="superadmin">{S(UsersPage)}</RequireRole>}/>
            <Route  path="audit-logs" element={ <RequireRole role="superadmin"> {S(AuditLogsPage)} </RequireRole>}/>
           </Route>
