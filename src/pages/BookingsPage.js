...
import { getBookings, createBooking, updateBooking, deleteBooking, getDoctors, sendReminder, syncAllDoctors } from '../services/api';
...
export default function BookingsPage() {
  ...
  const columns = [
    ...
    { field:'doctorId', headerName: isRTL?'الطبيب':'Doctor', width:140, valueGetter:(p)=> p.row.doctorId?.name||'—' },
