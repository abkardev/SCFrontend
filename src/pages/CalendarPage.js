...
import { getBookings, dragDropBooking, getDoctors, getBlockedSlots, syncFromGoogle } from '../services/api';

const STATUS_COLORS = {
  pending: '#ffa726', confirmed: '#1a73e8', completed: '#34a853',
  cancelled: '#ef5350', 'no-show': '#ab47bc',
};
    ...
    try {
      ...
      const bookingEvents = bookingsRes.data.map(b => ({
        ...
        extendedProps: {
          ...
          doctor: b.doctorId?.name, calendarLink: b.calendarLink,
        },
      }));
